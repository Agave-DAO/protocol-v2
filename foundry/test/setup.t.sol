...
contract SetupUpgrade is Test {
    ...
    address[] USDT = [0x4ECaBa5870353805a9F068101A40E0f32ed605C6]; 
    address[] USDTOracle = [0x68811D7DF835B1c33e6EEae8E7C141eF48d48cc7];
    ...
    function setUp() public {
        ...
        vm.stopPrank();
        vm.startPrank(0xbaBf238430d13245BBf04BC50f44d533d308AD59); // current oracle owner
        oracle.setAssetSources(USDT,USDTOracle);
        vm.stopPrank();
    }
    ...
    function testIsUpgraded() public{
       ...
       // assertGe(oracle.getAssetPrice(0x4ECaBa5870353805a9F068101A40E0f32ed605C6), 1);
        vm.stopPrank();
    }
}
